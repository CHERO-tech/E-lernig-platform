      ...
      <aside className="w-64 bg-white border-r border-gray-200 p-6 overflow-y-auto fixed h-screen">
        ...
        <div className="mb-8">
          ...
          <nav className="space-y-2">
            <Link href="/guardian/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-lg bg-forge-soft text-ember-strong font-medium">
              <Users size={18} />
              <span>Dashboard</span>
            </Link>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              ...
              { label: "Avg Progress", value: "67.5%", icon: TrendingUp, color: "bg-forge-soft text-ember-strong" },
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div className="bg-ember-strong h-2 rounded-full" style={{ width: `${ward.progress}%` }}></div>
                        </div>
                      </div>
                      ...
                      <div className="pt-2 border-t border-gray-200">
                        <p className={`text-sm font-medium flex items-center gap-2 ${ward.status === "On Track" ? "text-ember-strong" : "text-orange-600"}`}>
