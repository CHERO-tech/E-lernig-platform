      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-6 py-6">
          ...
          <div className="flex gap-4 mt-4 flex-wrap" role="group" aria-label="Search filters">
            <div>
              <label className="text-sm font-medium text-gray-700 mb-2 block" htmlFor="filter-level">Level</label>
              <select
                id="filter-level"
                value={filterLevel}
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 mb-2 block" htmlFor="sort-by">Sort By</label>
              <select
                id="sort-by"
                value={sortBy}
