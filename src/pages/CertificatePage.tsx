  ...
  return (
    <div className="min-h-screen py-12 px-8" style={{ background: "#F5F7F5" }}>
      <div className="max-w-4xl mx-auto">
        <Link to="/student" className="inline-block mb-6 text-sm font-medium" style={{ color: "#1F7A4B" }}>
          ← Back to Dashboard
        </Link>
        <div className="flex items-center justify-between mb-8">
          <div>
            <p className="font-mono text-xs mb-1" style={{ color: "#1F7A4B" }}>$ cat certificate.json</p>
            <h1 className="text-2xl font-bold" style={{ color: "#102019" }}>Certificate of Completion</h1>
          </div>
          <div className="flex gap-3">
            <button
              className="px-4 py-2.5 rounded-lg text-sm font-semibold border transition-all hover:bg-surface"
          ...
          <div className="p-16 text-center relative">
            ...
            <div className="flex items-center justify-center gap-3 mb-8">
              ...
              <div className="text-left">
                ...
                <p className="font-mono text-xs leading-tight" style={{ color: "#1F7A4B" }}>SKILLS ACADEMY</p>
              </div>
            </div>

            <p className="font-mono text-xs mb-2" style={{ color: "#606C66" }}>REPUBLIC OF RWANDA</p>

            <div className="my-8" style={{ borderTop: "1px solid #E2E8E4", borderBottom: "1px solid #E2E8E4", padding: "20px 0" }}>
              <h1 className="text-4xl font-bold mb-2 tracking-tight" style={{ color: "#071C12" }}>Certificate of Completion</h1>
              <p className="text-sm" style={{ color: "#606C66" }}>This is to certify that</p>
            </div>

            <div className="my-8">
              <h2 className="text-5xl font-bold mb-2 tracking-tight" style={{ color: "#1F7A4B" }}>
                Amahoro Jean de Dieu
              </h2>
              <p className="text-sm" style={{ color: "#606C66" }}>INES-Ruhengeri · Software Development Track</p>
            </div>

            <p className="text-lg mb-2" style={{ color: "#606C66" }}>has successfully completed</p>

            <div className="my-6">
              <h3 className="text-3xl font-bold mb-3" style={{ color: "#102019", letterSpacing: "-0.01em" }}>Web Development</h3>
              <p className="text-sm max-w-md mx-auto" style={{ color: "#606C66" }}>
            ...
            <div className="grid grid-cols-3 gap-6 my-8 max-w-lg mx-auto">
              {[
                ...
                <div key={item.label} className="text-center p-4 rounded-lg" style={{ background: "#F5F7F5" }}>
                  <p className="font-mono text-xs mb-1" style={{ color: "#606C66" }}>{item.label}</p>
            ...
            <div className="mb-8">
              <p className="text-sm mb-3" style={{ color: "#606C66" }}>Skills Obtained</p>
              <div className="flex flex-wrap gap-2 justify-center">
                {["HTML5", "CSS3", "JavaScript", "React", "Node.js", "REST APIs", "Git", "Responsive Design"].map((s) => (
                  <span key={s} className="font-mono text-xs px-3 py-1.5 rounded-full" style={{ background: "rgba(53,196,122,0.08)", color: "#1F7A4B", border: "1px solid rgba(53,196,122,0.2)" }}>{s}</span>
                ))}
              </div>
            </div>
            ...
            <div className="flex items-end justify-between mt-12 pt-8" style={{ borderTop: "1px solid #E2E8E4" }}>
              <div className="text-left">
                ...
                <p className="font-mono text-xs" style={{ color: "#606C66" }}>Course Instructor</p>
              </div>
              <div className="text-center">
                ...
                <p className="font-mono text-xs" style={{ color: "#606C66" }}>Official Seal</p>
              </div>
              <div className="text-right">
                ...
                <p className="font-mono text-xs" style={{ color: "#606C66" }}>TVET Digital Academy</p>
              </div>
            </div>

            <div className="mt-8 pt-6" style={{ borderTop: "1px solid #F5F7F5" }}>
              <p className="font-mono text-xs" style={{ color: "#606C66" }}>
                Verification Code: <span style={{ color: "#1F7A4B" }}>TVET-2026-WD-4821</span>
              </p>
              <p className="font-mono text-xs mt-1" style={{ color: "#606C66" }}>
        ...
        <div className="flex gap-4 mt-8 justify-center">
          <button className="px-6 py-3 rounded-lg font-semibold text-sm border transition-all hover:bg-surface" style={{ background: "#FFFFFF", color: "#102019", border: "1px solid #E2E8E4" }}>
            Share to LinkedIn
          </button>
          <Link to="/student" className="px-6 py-3 rounded-lg font-semibold text-sm" style={{ background: "#F5F7F5", color: "#606C66", border: "1px solid #E2E8E4" }}>
            Back to Dashboard
          </Link>
        </div>
      </div>
