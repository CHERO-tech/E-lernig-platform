      ...
      <aside className="w-64 bg-white border-r border-gray-200 p-6 overflow-y-auto fixed h-screen">
        ...
        <div className="mb-8">
          ...
          <nav className="space-y-2">
            <Link href="/school/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-lg bg-forge-soft text-ember-strong font-medium">
              <Building2 size={18} />
              <span>Dashboard</span>
            </Link>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              ...
              { label: "Active Programs", value: "8", icon: BookOpen, color: "bg-forge-soft text-ember-strong" },
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { title: "Data Science", students: "210", progress: 78, bgGradient: "from-brass via-teal-400 to-cyan-500" },
              ].map((program, i) => (
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="bg-ember-strong h-2 rounded-full" style={{ width: `${program.progress}%` }}></div>
                      </div>
                    </div>
                  </div>
                </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <button className="w-full px-4 py-3 bg-ember-strong text-white rounded-lg font-medium hover:bg-ember transition-colors text-left flex items-center gap-2">
                  <Plus size={18} />
                  Add Program
                </button>
